Instance: rizivinami10-2-2
InstanceOf: BeAllergyIntolerance
* recordedDate = "2023-08-12"
...
* asserter.identifier.system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/ssin"
...
* note.text = "Allergy to cat hair suspected, but after tests, it appears that patient is allergic to dust mites."
