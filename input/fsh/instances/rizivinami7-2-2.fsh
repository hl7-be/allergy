...
* clinicalStatus = http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical#resolved
* verificationStatus = http://terminology.hl7.org/CodeSystem/allergyintolerance-verification#confirmed
* note.text = "Allergy seems to have disappeared"